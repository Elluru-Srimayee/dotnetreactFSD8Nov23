...
function AddProduct(){
    ...
    var clickAdd = ()=>{
       ...
       product={
        ...
        console.log(product);
        fetch('http://localhost:5237/api/Product',{
            method:'POST',
            headers:{
